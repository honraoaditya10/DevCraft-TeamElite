...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-100 to-gray-200 flex items-center justify-center p-4 overflow-y-auto py-8">
        ...
        <div className="flex gap-6 bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="w-full lg:w-1/2 p-8 lg:p-12">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600 text-sm">Join our platform and start transforming your workflow</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <label className="flex items-start cursor-pointer gap-2">
                ...
                <span className="text-xs text-gray-700">
                  I agree to the <a href="#" className="text-blue-600 font-semibold hover:text-blue-700">Terms and Privacy Policy</a>
                </span>
              </label>
              ...
              <button
                type="submit"
                className="w-full bg-blue-600 text-white font-semibold py-2.5 rounded-lg hover:bg-blue-700 transition duration-200 text-sm mt-2"
              >
                Sign Up
              </button>
            </form>
          ...
          <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-gray-700 to-gray-900 relative overflow-hidden">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center text-white px-6">
                <h3 className="text-3xl font-bold mb-4">Smart Document Solutions</h3>
